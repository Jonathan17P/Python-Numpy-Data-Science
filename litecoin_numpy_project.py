...
print("Which is interesting, because that tells us, on average, Litecoin opens at a higher price then it closes at. So, if you're an investor, you may want to wait until the end of the day to invest in Litecoin")     #Displays the implication of the result from taking the element wise difference between the "close" array and the "open" array.
